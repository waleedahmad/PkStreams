...
@section('title')
    <title>
        {{$movie->name}} - Update / Admin - PkStreams
    </title>
@endsection()
                ...
                <div class="data-form">
                    <form action="/admin/movies/update" method="POST" enctype="multipart/form-data">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-textfield--full-width @if($errors->has('name')) is-invalid is-dirty @endif">
                            <input class="mdl-textfield__input" type="text" value="{{old('name') ? old('name') : $movie->name}}"  id="name" name="name"/>
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-textfield--full-width @if($errors->has('year')) is-invalid is-dirty @endif">
                            <input class="mdl-textfield__input" type="text" value="{{old('year') ? old('year') : $movie->year}}"   id="year" name="year"/>
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-textfield--full-width @if($errors->has('video_uri')) is-invalid is-dirty @endif">
                            <input class="mdl-textfield__input" type="text" value="{{old('video_uri') ? old('video_uri') : $movie->video_uri}}"   id="video_uri" name="video_uri"/>
